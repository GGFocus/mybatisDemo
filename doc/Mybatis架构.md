...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/2e1a17985f764fc78351995b1b47a10c.png)
## 一、基础支撑层
...
### 1.1 类型转换模块 
 在上一讲展示的订单系统实现中，我们可以在 mybatis-config.xml 配置文件中通过 <typeAliase> 标签为一个类定义一个别名，这里用到的“别名机制”就是由 MyBatis 基础支撑层中的类型转换模块实现的。
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/587d65604f194aeb930cc5277273e052.png)
### 1.2 日志模块
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/48a841baf7194c208b71ebc1207c826d.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/2a4678140eb045d4b949420ab2fa1d99.png)
执行 SQL 语句的核心流程图
